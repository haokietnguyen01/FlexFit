        ...
        return exerciseData.map((value, index) => (
            <div className="col-sm-12">
                ...
                <div className="col-sm-12 center">
                    ...
                    <button className="btn btn-submit" onClick={() => handleSubmit(value.id)}>Submit</button>
                </div>
            </div>
        ));
    };
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content modal-createPost">
                                ...
                                <div className="modal-body mb-2">
                                    <input className="mb-3 input-comment" type="text" name="comment" placeholder="Your comment" onChange={handleInput} />
                                </div>
                                {/* Modal footer */}
